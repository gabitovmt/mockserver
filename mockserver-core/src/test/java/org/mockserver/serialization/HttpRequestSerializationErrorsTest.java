...
public class HttpRequestSerializationErrorsTest {
    ...
    public void shouldHandleExceptionWhileDeserializingArray() {
        ...
        try {
            ...
            // then
            assertThat(iae.getMessage().replaceAll("\n", NEW_LINE), is("com.fasterxml.jackson.core.JsonParseException: Unrecognized token 'requestBytes': was expecting (JSON String, Number (or 'NaN'/'INF'/'+INF'), Array, Object or token 'null', 'true' or 'false')" + NEW_LINE +
                " at [Source: (String)\"requestBytes\"; line: 1, column: 13]"));
        }
    }
